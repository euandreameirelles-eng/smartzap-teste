                ...
                <div className="flex items-center gap-4">
                    ...
                    {step === 'review' ? (
                        <div className="flex items-center gap-2 group">
                            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-[var(--ds-border-default)] bg-[var(--ds-bg-surface)] hover:border-teal-500/50 focus-within:border-teal-500 focus-within:ring-1 focus-within:ring-teal-500/30 transition-all">
                                <input
                                    type="text"
                                    value={projectTitle}
                            ...
                            <React.Fragment key={s.key}>
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-1.5 rounded-lg transition-all ${isActive
                                            ...
                                            : isCompleted
                                                ? 'bg-[var(--ds-bg-elevated)] text-teal-400 border border-[var(--ds-border-default)] cursor-pointer hover:border-teal-500/40'
                                ...
                                {i < steps.length - 1 && (
                                    <div className={`w-8 h-px ${i < currentStepIndex ? 'bg-teal-500/50' : 'bg-[var(--ds-border-default)]'}`} />
                                )}
                            </React.Fragment>
                        );
                    })}
...
Quanto mais informação, melhor!`}
                            className="w-full h-80 p-4 rounded-xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-elevated)] focus:ring-2 focus:ring-teal-500/30 outline-none resize-none text-base text-[var(--ds-text-primary)] placeholder:text-[var(--ds-text-muted)]"
                        />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                {extractedContent.price && (
                                    <>
                                        ...
                                        <span className="text-[var(--ds-text-primary)]">
                                            {extractedContent.discount && <span className="text-teal-400 mr-2">{extractedContent.discount}</span>}
                                            {extractedContent.price}
                                        </span>
                                    </>
                                )}
                        ...
                        <div className="rounded-2xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-surface)] p-6 shadow-lg space-y-4">
                            ...
                            <textarea
                                ...
                                className="w-full h-40 p-4 rounded-xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-elevated)] focus:ring-2 focus:ring-teal-500/30 outline-none resize-none text-sm text-[var(--ds-text-primary)]"
                            />
                    ...
                    <div className="rounded-2xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-surface)] p-6 shadow-lg space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                value={prompt}
                                onChange={(e) => setPrompt(e.target.value)}
                                className="w-full h-32 p-4 rounded-xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-elevated)] focus:ring-2 focus:ring-teal-500/30 outline-none resize-none text-base text-[var(--ds-text-primary)]"
                            />
                        </div>
            ...
            {step === 'generating' && (
                <div className="flex flex-col items-center justify-center min-h-[400px]">
                    <Loader2 className="w-12 h-12 text-teal-300 animate-spin mb-4" />
                            ...
                            return (
                                <div
                                    ...
                                    className={`relative p-4 rounded-2xl border cursor-pointer transition-all hover:shadow-lg ${selectedIds.has(t.id)
                                            ? 'border-teal-600 dark:border-teal-400/40 bg-teal-100 dark:bg-teal-500/10'
                                ...
                                >
                                    ...
                                    <div className="absolute top-2 right-2 flex items-center gap-1">
                                        ...
                                        {selectedIds.has(t.id) && (
                                            <div className="p-1 bg-teal-500 text-black rounded-full">
                                    ...
                                    {t.buttons && t.buttons.length > 0 && (
                                        <div className="space-y-2">
                                            {t.buttons.map((btn, i) => (
                                                <div key={i} className="w-full py-2 px-3 bg-[var(--ds-bg-elevated)] text-center text-teal-700 dark:text-teal-200 text-sm rounded font-medium border border-[var(--ds-border-default)]">
                                    ...
                                    {t.wasFixed && (
                                        <div className="mt-4 p-2 bg-teal-100 dark:bg-teal-500/10 text-teal-700 dark:text-teal-200 text-xs rounded border border-teal-400 dark:border-teal-500/20 flex items-start gap-1">
                                            <Sparkles className="w-3 h-3 shrink-0 mt-0.5 text-teal-300" />
