...
export default function TemplateProjectDetailsPage() {
    ...
    const sections = [
        { id: 'APPROVED', label: 'Aprovados', count: groups.APPROVED.length, color: 'teal', icon: CheckCircle },
                                ...
                                {isEditingTitle ? (
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            autoFocus
                                            className="text-2xl sm:text-3xl font-bold bg-transparent border-b-2 border-teal-500 outline-none text-white min-w-[200px]"
                                        />
                                        <button
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <section.icon className={cn("w-5 h-5", {
                                            'text-teal-300': section.color === 'teal',
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={cn(
                                                        ...
                                                        isActive
                                                            ? "bg-teal-500/10 border-teal-500/30 ring-1 ring-teal-500/40"
                                                            ...
                                                            {isDraft && (
                                                                <>
                                                                    <button
                                                                        ...
                                                                        className="p-1 text-zinc-400 hover:text-teal-300 hover:bg-teal-500/10 rounded transition-colors opacity-0 group-hover:opacity-100 disabled:opacity-50"
                        ...
                        <div className="mt-6 p-4 bg-zinc-900/60 border border-white/10 rounded-2xl shadow-[0_12px_30px_rgba(0,0,0,0.35)]">
                            ...
                            <div className="space-y-2 text-xs text-gray-400">
                                <div className="flex justify-between">
                                    ...
                                    <span className={cn(
                                        "font-medium",
                                        previewItem.meta_status === 'APPROVED' && "text-teal-300",
