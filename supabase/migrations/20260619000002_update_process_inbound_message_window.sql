-- Atualiza process_inbound_message para preencher last_customer_message_at.
-- Esse campo registra exclusivamente a última mensagem recebida do cliente (inbound),
-- usado pelo frontend para calcular se a janela de 24h do WhatsApp está aberta.
...
'Processa mensagem inbound de forma atômica: busca/cria conversa + cria mensagem + atualiza contadores + atualiza last_customer_message_at para controle da janela de 24h do WhatsApp.';
