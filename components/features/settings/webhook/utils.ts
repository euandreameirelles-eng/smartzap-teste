...
export function getWebhookStatus(
  ...
  if (config?.phone_number) {
    const isBlueTick = config.phone_number === activeUrl;
    return {
      status: isBlueTick ? 'bluetick' : 'other',
  ...
  return [
    {
      ...
      isBlueTick: config?.phone_number === activeUrl,
      color: 'emerald',
    ...
    },
    {
      ...
      isBlueTick: config?.whatsapp_business_account === activeUrl,
      color: 'blue',
    ...
    },
    {
      ...
      isBlueTick: config?.application === activeUrl,
      color: 'zinc',
...
export function getCardColor(
  ...
  if (webhookStatus.status === 'bluetick') return 'emerald';
