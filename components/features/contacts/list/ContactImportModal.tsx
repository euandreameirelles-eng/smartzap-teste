      ...
      {columnMapping.phone && (
        <div className="mt-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            ...
            <div className="bg-teal-500/10 rounded-lg p-2.5 border border-teal-500/20 text-center">
              <div className="flex items-center justify-center gap-1 mb-0.5">
                <UserCheck size={12} className="text-teal-400" />
                <span className="text-base font-bold text-teal-400">{previewStats.validContacts}</span>
              </div>
              <p className="text-[9px] text-teal-500/70 uppercase">Novos</p>
            </div>
  ...
  <div className="text-center py-8">
    ...
    <div className="grid grid-cols-4 gap-3 max-w-lg mx-auto mb-8">
      ...
      <div className="bg-teal-500/10 rounded-xl p-4 border border-teal-500/20">
        <p className="text-2xl font-bold text-teal-400">{result.inserted}</p>
        <p className="text-xs text-teal-500/70">Novos</p>
      </div>
    ...
    {fixState === 'done' && fixResult && (
      <div className="flex items-center justify-center gap-2 max-w-lg mx-auto mb-4 p-3 bg-teal-500/10 border border-teal-500/20 rounded-lg">
        ...
        <div className="mt-3">
          ...
          {showFormats && (
            <div className="mt-2 rounded-lg border border-white/10 bg-zinc-900/60 p-3 space-y-3 text-xs">
              ...
              <div>
                <p className="text-teal-400 font-medium mb-1.5">✅ Aceitos e corrigidos automaticamente</p>
                  ...
                  <tbody className="divide-y divide-white/5">
                    {[
                      ...
                      <tr key={i}>
                        ...
                        <td className="py-1 font-mono text-teal-400">{out_}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
