                ...
                <div className="px-6 py-4 border-b border-white/10 flex items-center justify-between bg-zinc-950/40 backdrop-blur-xl z-10">
                    <div className="flex items-center gap-3">
                        <div className="p-2 rounded-xl bg-teal-500/10 border border-teal-500/20">
                            {hasTemplates ? <Target className="w-5 h-5 text-teal-300" /> : <Sparkles className="w-5 h-5 text-teal-300" />}
                        </div>
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    <textarea
                                        ...
                                        className="w-full h-40 bg-zinc-950/40 border border-white/10 rounded-xl p-5 text-white placeholder:text-zinc-500 focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/30 outline-none resize-none transition-all text-base leading-relaxed"
                                    />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full bg-zinc-950/40 border border-white/10 rounded-xl px-4 py-3 text-white outline-none focus:border-teal-500/50 appearance-none cursor-pointer hover:bg-white/5 transition-colors"
                                        >
                                            {[3, 5, 10, 15, 20].map(n => (
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`relative group cursor-pointer transition-all duration-300 border rounded-2xl p-5 hover:scale-[1.01] ${isSelected
                                                ? 'bg-teal-500/10 border-teal-500/30 shadow-[0_0_20px_-10px_rgba(16,185,129,0.2)]'
                                        ...
                                        >
                                            ...
                                            <div className="flex justify-between items-start mb-3">
                                                <div className="flex-1 min-w-0 pr-4">
                                                    <h3 className={`text-sm font-bold truncate ${isSelected ? 'text-teal-400' : 'text-zinc-300'}`}>
                                                        {template.name}
                                                    </h3>
                    ...
                    {!hasTemplates ? (
                        <>
                            ...
                            >
                                {isGenerating ? (
                                    ...
                                    <><Sparkles size={18} className="text-teal-600" /> Gerar Templates</>
                                )}
                            </button>
                        </>
                    ) : (
                        <>
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    onClick={onSelectAll}
                                    className="px-4 py-2 text-zinc-400 hover:text-teal-300 text-sm font-medium transition-colors"
                                >
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-8 py-3 bg-teal-500 text-black font-semibold rounded-xl hover:bg-teal-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
